...
/**
 * This class implements the highscore list which stores all scores in three
...
public class HighscoreList {
	/*
	 * game name points guesses time spent
	 */
	...
	public void loadChanges(SharedPreferences listOfScores) {
		Type listType = new TypeToken<ArrayList<HighscoreListItem>>() {
		}.getType();
		Gson gson = new Gson();
		String highscoreParameters = listOfScores.getString(
				"highscore list easy", "");
		String highscoreParameters2 = listOfScores.getString(
				"highscore list medium", "");
		String highscoreParameters3 = listOfScores.getString(
				"highscore list hard", "");

		if (highscoreParameters != "" && highscoreParameters2 != ""
				&& highscoreParameters3 != "") {
